...
public:
    ...
    virtual bool add(const int& newEntry) = 0;
    ...
    virtual bool remove(const int& anEntry) = 0;
    ...
    virtual int getFrequencyOf(const int& anEntry) const = 0;
    ...
    virtual vector<int> toVector() const = 0;
